...
import {
  cssClasses,
  strings,
} from "@douyinfe/semi-foundation/button/constants";
...
class IconButton extends PureComponent<IconButtonProps> {
  ...
  static propTypes = {
    ...
    noHorizontalPadding: PropTypes.oneOfType([
      PropTypes.bool,
      PropTypes.string,
      PropTypes.array,
    ]),
  ...
  render() {
    ...
    const children =
      originChildren != null ? (
        <span className={btnTextCls} x-semi-prop={xSemiProp}>
          {originChildren}
        </span>
      ) : null;
